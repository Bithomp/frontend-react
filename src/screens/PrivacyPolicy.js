  ...
  return (
    <div className="content-text">
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Bithomp, accessible from <a href="https://bithomp.com" rel="noreferrer" target="_blank">https://bithomp.com</a></p>
        </li>
        <li>
      ...
      <p>Our Company would like to make sure you are fully aware of all of your data protection rights.
        Every user is entitled to the following:</p>
      <ul>
        <li><strong>The right to access:</strong> You have the right to request Us for copies of your personal data. We may charge you a small fee for this service.</li>
