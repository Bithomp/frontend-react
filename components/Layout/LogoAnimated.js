export default function SvgImage() {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" id="A" viewBox="0 0 181 52" fill="#63a6b9">
      ...
      <g mask="url(#D)">
        <path d="M.5,13.5,16.1,4.6l15.7,9v3.9L16.2,8.6.5,17.5Z" strokeDashoffset="79.96430969238281" strokeDasharray="79.96430969238281" {...outlineProps} />
        <path d="M4,40.5l-3.5-2V20.7l15.8-8.9,15.5,8.9v4L16.2,15.8,4,22.7Z" strokeDashoffset="111.61508178710938" strokeDasharray="111.61508178710938" {...outlineProps} />
        <path d="M44.5 13.5v17.7l-15.7 9-3.5-2 15.6-8.9.1-17.8z" strokeDashoffset="79.61946105957031" strokeDasharray="79.61946105957031" {...outlineProps} />
        <path d="M19,3l3.5-2L38.2,9.9V27.8L22.6,36.7,19,34.6l15.7-8.9V11.9Z" strokeDashoffset="112.00057983398438" strokeDasharray="112.00057983398438" {...outlineProps} />
        <path d="M22.5,51,6.9,42.1V24.2l3.5-2V40.1L26,49Z" strokeDashoffset="79.78272247314453" strokeDasharray="79.78272247314453" {...outlineProps} />
        <path d="M44.4 34.5v4l-15.7 8.9-15.6-9V20.7l3.6-2-.1 17.8 12.2 6.9z" strokeDashoffset="111.65198516845703" strokeDasharray="111.65198516845703" {...outlineProps} />
