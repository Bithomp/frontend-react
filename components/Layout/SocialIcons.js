...
export default function SocialIcons() {
  return (
    <>
      <a href={"https://x.com/" + (xahauNetwork ? "XahauExplorer" : "bithomp")}><img src="/images/twitter.svg" className="footer-social-icon" alt="twitter" /></a>
      ...
      <a href="https://www.reddit.com/user/bithomp/"><img src="/images/reddit.svg" className="footer-social-icon" alt="reddit" /></a>
      <a href="https://github.com/Bithomp"><img src="/images/github.svg" className="footer-social-icon" alt="github" /></a>
    </>
  )
}
