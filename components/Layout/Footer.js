      ...
      <div className="footer-content">
        <div className="footer-menu">
          ...
          <div className="footer-menu-column">
            ...
            {!xahauNetwork && <Link href="/learn/what-is-xrp">What is XRP?</Link>}
            {!xahauNetwork && <Link href="/learn/what-is-the-xrp-ledger">What is the XRP Ledger?</Link>}
            <Link href="learn/the-bithomp-explorer-advantages">Why is the Bithomp explorer?</Link>
            <Link href="/learn">Visit our learn hub...</Link>
          </div>
