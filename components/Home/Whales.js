...
export default function Whales({ currency, data, setData }) {
  ...
  */
  ...
  return (
    <>
      <SEO
        title={'The Most significant transactions for the last 24 hours.' + explorerName}
        description={
          'Explore the largest transactions and the most significant movements on the in the last 24 hours.' +
          explorerName
        }
      />
      <p style={{ marginBottom: '20px', fontSize: '16px', lineHeight: '1.4' }}>
        Explore the largest {explorerName} transactions and track major asset movements over the last 24 hours.
      </p>
      {data?.length > 0 && (
        <>
