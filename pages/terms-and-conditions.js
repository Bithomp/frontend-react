  ...
  return (
    <>
      ...
      <div className="content-text">
        ...
        <p>2.6 "Data" covers (i) any data and content uploaded, posted, transmitted, or otherwise made available by Bithomp on its website www.bithomp.com or other associated platforms (including information related to listed digital coins, cryptocurrency market data, additional statistics, initial coin offerings data, and coin searches); and (ii) in cases where Bithomp provides interactive channels for user engagement, any data, content, comments, profile information, and messages uploaded, posted, or transmitted by other users through such channels.</p>
