  ...
  return (
    <>
      ...
      <div className="content-text">
        ...
        <p>The Bithomp API, as outlined below, is provided by Bithomp AB ("Bithomp," "Company," "we," "us," or "our"). If you intend to utilize our Bithomp API, it is essential that you fully accept all the terms and conditions outlined in this Bithomp API Terms of Service ("API Terms"). Before commencing the use of our Bithomp API, it is imperative that you thoroughly read and agree to our API Terms. By accessing or using our Bithomp API, you are expressing your full and legal agreement to abide by all the provisions within these API Terms, in addition to our <Link href='/privacy-policy'>Privacy policy</Link> and <Link href='/terms-and-conditions'>Terms and Conditions</Link>, the terms of which are integrated herein by reference.</p>
        <p>In the event that you are using our Bithomp API on behalf of a corporation, partnership, or other legal entity, you confirm that you have the proper authorization to represent and legally bind such entity to the API Terms. In such cases, any references to "you" or "your" in these API Terms also apply to the represented entity. If you lack the aforementioned authority or if you (or the entity you represent) do not agree with any terms in these API Terms, our <Link href='/privacy-policy'>Privacy policy</Link>, and/or <Link href='/terms-and-conditions'>Terms and Conditions</Link>, you are not permitted to use the Bithomp API.</p>
        <p>As a user of the Bithomp API, you acknowledge and accept that the API Terms, along with our <Link href='/privacy-policy'>Privacy policy</Link> and <Link href='/terms-and-conditions'>Terms and Conditions</Link>, form a legally binding contract between Bithomp and yourself. This agreement holds true even though it is in electronic form and does not necessitate physical signing or online acknowledgment, governing your use of our Bithomp API.</p>

        <p><strong>2. Definitions</strong></p>
        <p>2.1 The term "Application" or "App" refers to any software, mobile application, website, product, or service developed, created, or offered using our Bithomp API.</p>
        <p>2.2 "API Documentation" pertains to the documentation, data, and information provided by Bithomp regarding the use of our Bithomp API through our API Site.</p>
        <p>2.3 "API Site" denotes our API development site located <Link href='/admin'>HERE</Link></p>
        <p>2.4 "Bithomp API" encompasses the Application Programming Interface ("API") publicly offered by our Company, along with the associated API Documentation.</p>
        <p>2.5 The "Bithomp Brand" includes the "BITHOMP" brand name and other branding elements, names, logos, slogans, service marks, trademarks, and trade names owned by Bithomp.</p>
        <p>2.6 "Data" covers (i) any data and content uploaded, posted, transmitted, or otherwise made available by Bithomp on its websites: www.bithomp.com and www.xahauexplorer.com, or other associated platforms (including information related to listed digital coins, cryptocurrency market data, additional statistics, initial coin offerings data, and coin searches); and (ii) in cases where Bithomp provides interactive channels for user engagement, any data, content, comments, profile information, and messages uploaded, posted, or transmitted by other users through such channels.</p>
        <p>2.7 "Service(s)" encompasses Bithomp’s products and services, including but not limited to the Bithomp API, its websites: www.bithomp.com and www.xahauexplorer.com (the "Site"), and all software, applications, mobile applications, data, reports, text, images, messaging channels, message services, updates, content, newsletters, price alerts, merchandise, databases, forums, articles, guides, reports, and other information made available by or on behalf of Bithomp through any of the aforementioned. The term "Service" excludes information, software applications, mobile applications, platforms, websites, or services provided by you or a third party (including Applications), whether or not the Bithomp API is incorporated into your product or a third party's services or product, and regardless of whether Bithomp designates them as "official integrations."</p>
        <p>2.8 "Users" includes all individuals utilizing our Bithomp API, which encompasses you.</p>
        <p><strong>3. Grant of License</strong></p>
        <p>3.1 In accordance with the terms outlined in these API Terms, Bithomp grants you a limited, non-exclusive, non-assignable, non-transferable, and irrevocable license to utilize the Bithomp API for the development, testing, and support of any software application, mobile application, website, platform, service, or product. This license also extends to the integration or incorporation of the Bithomp API into your Application. It is important to note that this license is subject to the restrictions specified in Section 4 and Section 9 below. Any violation of Section 4 will result in the automatic termination of the granted license, and Bithomp holds no liability in such termination. Consequently, Bithomp reserves the right to immediately suspend, obstruct, restrict, or terminate your access to and/or use of your account and/or Bithomp API without notice or liability to you. This action is without prejudice to any other remedies available to Bithomp in law, contract, tort, or equity.</p>
        <p>3.2 Your use of the Bithomp API is contingent upon your ongoing compliance with the provisions outlined in these API Terms. In order to enhance the development of our Bithomp API, Applications, Data, Services, platforms, channels, and/or products (referred to individually and collectively as "our Property"), we retain the right to make changes to the Bithomp API and/or these API Terms at any time without notifying you. It is your responsibility to regularly check our <Link href='/admin'>SITE</Link> for updates to the Bithomp API and/or these API Terms. Additionally, certain aspects, events, methods, and properties of our Bithomp API may be undocumented. Considering the potential changes to our Bithomp API (whether documented or not), Applications, Data, Services, platforms, channels, and/or products at any time, you agree not to rely on any function, behavior, capability, or other aspects of our Bithomp API.</p>

        <p><strong>4. Scope of Use</strong></p>
        ...
        <p>4.1.7.1 You must not use the Bithomp API to promote gambling, and any advertisements around your Products incorporating or integrating the Bithomp API must not constitute adult/sexual content or offer online gambling.</p>
        <p>4.1.7.2 Using any Data, information, or other content from any of our Property in advertisements or for targeting advertisements in your Products or any part thereof is prohibited.</p>
        <p>4.1.7.3 Using any contact information obtained from our Property or any contact information of other Users (including email addresses) to contact Users without the prior written consent of Bithomp and the owners of such contact information is not allowed.</p>
        <p>4.1.7.4 Your Products and associated analyses or research must not isolate a small group of individuals or any single individual for any unlawful, harassing, or discriminatory purposes.</p>
        <p>4.1.7.5 Making public statements or representations in any mode, media, or channel regarding Bithomp or any of our Products (including the Bithomp API) without our prior written consent is prohibited.</p>
        ...
        <p><strong>11. Your Warranties</strong></p>
        ...
        <p>1.1. Users can register on the Platform by visiting <Link href='/admin'>Partner Portal</Link>.</p>
        <p>1.2. The administration may, at its discretion, employ additional registration procedures, including Recaptcha V3 ("CAPTCHA").</p>
        <p>1.3. After registration, users receive a unique Account and access to the Dashboard.</p>
        <p>1.4. All activities conducted in the Dashboard are considered the personal actions of the user. The user bears sole responsibility for any actions taken using their Account and the consequences that may arise from such use.</p>
        <p>1.5. Users are exclusively responsible for:</p>
        <p>a) Safeguarding their username and password.</p>
        <p>b) Dealing with the consequences in case of loss and/or disclosure of login and password to third parties.</p>
        <p>1.6. Users are obligated to take appropriate measures independently to secure their Account and prevent unauthorized access by third parties. This includes ensuring that the password is not saved in the browser, even when utilizing cookie technology, especially when a third party has access to the user's computer or mobile device.</p>
        <p>1.7. Users are not permitted to transfer their Account data to third parties. If Account data is transferred, users bear full responsibility for the actions conducted by third parties using the user's Account.</p>

        <p><strong>2. Terms of Use</strong></p>
        <p>2.1. The Administration is not obligated to provide consulting and technical support to the User.</p>
        <p>2.2. The Platform is integrated with various services, such as analytics, payment, and mailing services. The Platform solely facilitates access to these services. The relationship between the User and the service provider using the Platform (service owner) is governed by the service documents (agreement, rules of use, etc.), and all matters related to the use of such services are independently resolved between the service owner and the User.</p>
        ...
        <p>f) Damage that may be caused to any of the User's devices, media, and/or software as a result of the use of the Platform and/or Services.</p>
        <p>g) Consequences of the transfer of Bots between Accounts.</p>
        <p>You can contact us with queries, comments, and feedback via email at <Mailto email='support@bithomp.com' headers={{ subject: 'API & Bots Terms of Use' }} /></p>
        
        
        <h1>Bithomp Pro Subscription Terms of Use</h1>
        <p><strong>Subscription Payment</strong></p>
        <p>By subscribing to Bithomp Pro paid services, you agree to pay the applicable subscription fees as indicated at the time of purchase. All payments are to be made in accordance with the payment terms specified on the website. The payment for the subscription is non-refundable. Once the subscription fee is paid, it cannot be reclaimed under any circumstances.</p>
        <p><strong>User Responsibility</strong></p>
        <p>You acknowledge and agree that the use of Bithomp Pro services is entirely at your own risk. The service is provided on an "as is" and "as available" basis.</p>
        <p><strong>Limitation of Liability</strong></p>
        <p>Bithomp.com and its employees shall not be liable for any direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use the services. This includes, but is not limited to, damages for loss of profits, data, or other intangible losses arising out of or in connection with the use or performance of the service.</p>
        <p><strong>Changes to Subscription and Terms</strong></p>
        <p>We reserve the right to modify the subscription fees, payment terms, or these terms of use at any time. Any changes will be effective upon posting on the website or notifying you via email or other means. It is your responsibility to review these terms periodically for any changes.</p>
        <p>By using Bithomp Pro paid services, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions.</p>
