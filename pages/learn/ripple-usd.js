    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <article className="prose sm:prose-lg dark:prose-invert max-w-4xl my-10">
          ...
          <p>
            RLUSD is a USD-pegged stablecoin currently issued on two major blockchain platforms: the XRP Ledger (XRPL)
            and Ethereum. It is backed 1:1 with US dollars ensuring both transparency and financial stability.
          </p>
          <p>
          ...
          <h3>Why RLUSD?</h3>
          <p>
            Built for Speed and Stability. As a stablecoin built on the XRP Ledger, RLUSD inherits some powerful
            features:
          </p>
          <ul>
            <li>
