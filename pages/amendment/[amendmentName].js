...
export default function AmendmentVoting({ amendmentName, initialData, initialErrorMessage }) {
  ...
  return (
    <>
      ...
      <div className="content-text">
        <h1 className="center">Amendment: {amendmentName}</h1>
          ...
          <table className="table-mobile">
            ...
            <tbody>
              {!initialErrorMessage && validators?.validators?.length > 0 ? (
                ...
                //   .filter((v) => v.amendments?.includes(amendmentName))
                  .map((v, i) => (
                    <tr key={i}>
