...
export async function getServerSideProps({ query, res }) {
  ...
  const svg = `
    <svg width="${width}" height="630" viewBox="0 0 ${width} 630" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="${textX}" y="${subtitleY}" font-family="Arial, Helvetica, sans-serif" font-size="${square ? 29 : 38}" font-weight="600" fill="${theme.muted}">Top holders and concentration</text>
