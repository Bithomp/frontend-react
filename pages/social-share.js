...
export default function SocialSharePage() {
  ...
  const divStyle = {
    ...
    top: "calc(50% - " + ((size + spaceBetweenLogoAndButtons + logoHeight + (countBigButtons + 1) * spaceBetweenLogoAndButtons + longButtonWidth * countBigButtons) / 2) + "px)"
  }
  ...
  return (
    <>
      <div style={divStyle}>
        ...
        <a href="https://bithomp.com" className='button-action wide center'>Bithomp website</a>

        <div style={{ height: spaceBetweenLogoAndButtons + "px" }}> </div>

        <a href="https://discord.com/invite/ZahGJ29WEs" className='button-action wide center'>Join our Discord</a>
        ...
        <div>
          ...
          <a href="https://www.instagram.com/bithomp/">
            <Img src="/images/social-share/instagram.svg" alt="instagram" width={size} height={size} style={iconStyle} />
          </a>
